...
#if !defined(__KERNEL_OPENCL__) || defined(__SVM_EVAL_NODES_SHADER_TYPE_SURFACE_2__)
...
#  endif
    ...
    path_state_modify_bounce(state, true);
#  if !defined(__KERNEL_OPENCL__) || defined(__SVM_EVAL_NODES_SHADER_TYPE_SURFACE_3__)
