...
#  if !defined(__KERNEL_OPENCL__) || defined(__SVM_EVAL_NODES_SHADER_TYPE_SURFACE_0__)
...
#if !defined(__KERNEL_OPENCL__) || defined(__SVM_EVAL_NODES_SHADER_TYPE_SURFACE_1__)
  /* evaluate */
  int path_flag = 0; /* we can't know which type of BSDF this is for */
  shader_eval_surface(kg, &sd, &state, NULL, path_flag | PATH_RAY_EMISSION);
#endif
