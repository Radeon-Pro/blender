    ...
    int max_hits)
{
  ...
  uint node_offset = kernel_tex_fetch(__object_node, local_object);
  ...
  __global Node const *restrict nodes = (__global Node *)(&kernel_tex_fetch(__bvh_amd,
	...
	uint prim_offset = 0;//box_node_.prim_offset;
